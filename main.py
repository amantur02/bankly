...
from exceptions import BanklyVisitHTTPException
...
@app.exception_handler(BanklyVisitHTTPException)
async def store_visit_exception_handler(_: Request, exc: BanklyVisitHTTPException):
    return JSONResponse(
